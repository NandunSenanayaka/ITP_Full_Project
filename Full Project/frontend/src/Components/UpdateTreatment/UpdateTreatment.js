    ...
    const handleChange = (e) => {
        ...
        switch (name) {
            case "name":
                ...
                break;
            case "description":
                if (descriptionBenefitRegex.test(value) || value === "") {
                    setInputs((prevState) => ({
                        ...prevState,
                        [name]: value,
                    }));
                    ...
                    setErrors((prevState) => ({
                        ...prevState,
                        description: "Description can only contain letters, commas, and periods.",
                    }));
                }
                break;
            case "benefit":
                if (descriptionBenefitRegex.test(value) || value === "") {
                    ...
                    setErrors((prevState) => ({
                        ...prevState,
                        benefit: "Benefit can only contain letters, commas, and periods.",
                    }));
                }
                break;
            case "duration":
                if (durationRegex.test(value) || value === "") {
                    ...
                    setErrors((prevState) => ({
                        ...prevState,
                        duration: "Duration must be a number between 1 and 365.",
                    }));
                }
                break;
            default:
